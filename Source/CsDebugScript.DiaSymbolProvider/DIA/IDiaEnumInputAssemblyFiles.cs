...
namespace DIA
{
    ...
    public interface IDiaEnumInputAssemblyFiles
    {
        ...
        /// <returns>Returns an <see cref="IDiaInputAssemblyFile"/> object representing the input assembly file.</returns>
        ...
        /// </summary>
        /// <returns>Returns an <see cref="IDiaEnumInputAssemblyFiles"/> object that contains a duplicate of the enumerator. The input assembly files are not duplicated, only the enumerator.</returns>
        [return: MarshalAs(UnmanagedType.Interface)]
