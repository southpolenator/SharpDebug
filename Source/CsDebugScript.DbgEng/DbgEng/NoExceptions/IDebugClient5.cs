...
namespace DbgEng.NoExceptions
{
    ...
    /// </summary>
    /// <seealso cref="DbgEng.IDebugClient4" />
    [ComImport, Guid("E3ACB9D7-7EC2-4F0C-A0DA-E81E0CBBE628"), InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
...
#pragma warning restore CS0108 // XXX hides inherited member. This is COM default.
        ...
        /// </summary>
        /// <param name="RemoteOptions">Specifies how the debugger engine will connect with the process server. These are the same options passed to the -premote option on the WinDbg and CDB command lines.</param>
        /// <param name="Server">Receives a handle for the process server. This handle is used when creating or attaching to processes by using the process server.</param>
        [PreserveSig]
        ...
        /// </summary>
        /// <param name="Callbacks">Receives an interface pointer to the <see cref="IDebugOutputCallbacksWide"/> object registered with the client.</param>
        [PreserveSig]
        ...
        /// </summary>
        /// <param name="Callbaks">Receives an interface pointer to the event callbacks object registered with this client.</param>
        [PreserveSig]
        int GetEventCallbacksWide(
            [Out, MarshalAs(UnmanagedType.Interface)] out IDebugEventCallbacksWide Callbaks);
        ...
        /// </summary>
        /// <param name="Number">Receives the number of input callbacks that have been registered.</param>
        [PreserveSig]
        ...
        /// </summary>
        /// <param name="Number">Receives the number of output callbacks that have been registered.</param>
        [PreserveSig]
        ...
        /// <param name="Number">Receives the number of event callbacks that are interested in at least one of the events in <paramref name="EventFlags"/>.</param>
        [PreserveSig]
