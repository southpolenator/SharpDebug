...
{
    /// <summary>
    /// E2E tests for verifying various functionalities of CsScript against NativeDumpTest.linux.x64.gcc.
    /// </summary>
    [TestClass]
    [DeploymentItem(DefaultDumpFile)]
    public class NativeDumpTest64LinuxGCC : TestBase
    {
        private const string DefaultDumpFile = @"..\..\..\dumps\NativeDumpTest.linux.x64.gcc.coredump";
        private const string DefaultModuleName = "NativeDumpTest.linux.x64.gcc";
