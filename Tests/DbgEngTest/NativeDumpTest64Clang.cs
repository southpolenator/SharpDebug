...
namespace DbgEngTest
{
    ...
    public class NativeDumpTest64Clang : TestBase
    {
        private const string DefaultDumpFile = @"..\..\..\dumps\NativeDumpTest.x64.clang.mdmp";
        private const string DefaultModuleName = "NativeDumpTest_x64_clang";
