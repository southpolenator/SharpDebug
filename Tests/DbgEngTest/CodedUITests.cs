...
namespace DbgEngTest
{
    ...
    public class CodedUITests : TestBase
    {
        ...
        private static void OpenInteractiveWindow()
        {
            ...
            if (!window.TryFind())
            {
                ...
                WaitForReadyState(25000);
                UIMap.AssertInteractiveWindowReady();
            }
        }

        private static void CloseInteractiveWindow(int millisecondsTimeout = 5000)
        {
            SendInput("q{Space}{Enter}");
            UIMap.InteractiveWindow.WaitForControlNotExist(millisecondsTimeout);
        }

        private static void WaitForReadyState(int millisecondsTimeout = 15000)
        {
        ...
        private static void WaitForExecutionState(int millisecondsTimeout = 15000)
        {
            PromptLabel label = UIMap.InteractiveWindow.InteractiveWindowContent.ResultContainer.PromptLabel;
        ...
        private static void SendInput(string input, ModifierKeys modifierKeys = ModifierKeys.None)
        {
